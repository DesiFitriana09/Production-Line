...
void PART3_init__(PART3 *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->CLPRISE3,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->CLPRISE6,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->CLPRISE9,__BOOL_LITERAL(FALSE),retain)
...
void PART3_body__(PART3 *data__) {
  ...
  if (__GET_VAR(data__->_TMP_MOVE83_ENO,)) {
    __SET_VAR(data__->,CLPRISE3,,__BOOL_LITERAL(TRUE));
  };
  ...
  if (__GET_VAR(data__->_TMP_MOVE305_ENO,)) {
    __SET_VAR(data__->,CLPRISE9,,__BOOL_LITERAL(TRUE));
  };
  ...
  TON_body__(&data__->TON14);
  if (__GET_VAR(data__->TON14.Q,)) {
    __SET_VAR(data__->,CLPRISE3,,__BOOL_LITERAL(FALSE));
  };
  ...
  __SET_VAR(data__->,_TMP_MOVE311_OUT,,__PART3_MOVE__INT__INT17(
  ...
  __SET_VAR(data__->,_TMP_MOVE316_OUT,,__PART3_MOVE__INT__INT18(
  ...
  if (__GET_VAR(data__->TON48.Q,)) {
    __SET_VAR(data__->,CLPRISE9,,__BOOL_LITERAL(FALSE));
  };
  ...
  TON_body__(&data__->TON16);
  __SET_VAR(data__->,_TMP_MOVE100_OUT,,__PART3_MOVE__INT__INT19(
  ...
  if (__GET_VAR(data__->_TMP_MOVE194_ENO,)) {
    __SET_VAR(data__->,CLPRISE6,,__BOOL_LITERAL(TRUE));
  };
  if (__GET_VAR(data__->_TMP_MOVE194_ENO,)) {
    __SET_VAR(data__->,VIR11,,__BOOL_LITERAL(TRUE));
  };
  ...
  if (__GET_VAR(data__->TON31.Q,)) {
    __SET_VAR(data__->,CLPRISE6,,__BOOL_LITERAL(FALSE));
  };
