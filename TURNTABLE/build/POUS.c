...
void MUTERR_body__(MUTERR *data__) {
  ...
  __SET_VAR(data__->,CON1,,((!(__GET_VAR(data__->SEN1VIR,)) && (__GET_VAR(data__->CON1,) || __GET_VAR(data__->START,))) && __GET_VAR(data__->STOP,)));
  __SET_VAR(data__->TON0.,IN,,__GET_VAR(data__->SEN1,));
  __SET_VAR(data__->TON0.,PT,,__time_to_timespec(1, 2000, 0, 0, 0, 0));
  TON_body__(&data__->TON0);
  __SET_VAR(data__->,SEN1VIR,,__GET_VAR(data__->TON0.Q,));
  __SET_VAR(data__->,TURNROLL,,(!(__GET_VAR(data__->SEN2,)) && ((!(__GET_VAR(data__->TFRONTLIMIT,)) && (__GET_VAR(data__->SEN1,) || __GET_VAR(data__->TURNROLL,))) || __GET_VAR(data__->TFRONTLIMIT90,))));
  __SET_VAR(data__->,TURNTABLE,,__GET_VAR(data__->TFRONTLIMIT,));
  __SET_VAR(data__->,CON2,,((!(__GET_VAR(data__->SEN3,)) && __GET_VAR(data__->STOP,)) && (__GET_VAR(data__->CON2,) || __GET_VAR(data__->TFRONTLIMIT90,))));
