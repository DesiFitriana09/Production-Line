...
void DIGDISPLY_init__(DIGDISPLY *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->DIGDISPY,0,retain)
  __INIT_VAR(data__->SYSRUN,__BOOL_LITERAL(FALSE),retain)
  CTU_DINT_init__(&data__->CTU_DINT0,retain);
  R_TRIG_init__(&data__->R_TRIG1,retain);
  __INIT_VAR(data__->_TMP_DINT_TO_INT18_OUT,0,retain)
}

// Code part
void DIGDISPLY_body__(DIGDISPLY *data__) {
  // Initialise TEMP variables

  __SET_VAR(data__->,SYSRUN,,__GET_VAR(data__->START,));
  __SET_VAR(data__->R_TRIG1.,CLK,,__GET_VAR(data__->SYSRUN,));
  R_TRIG_body__(&data__->R_TRIG1);
  __SET_VAR(data__->CTU_DINT0.,CU,,__GET_VAR(data__->R_TRIG1.Q,));
  __SET_VAR(data__->CTU_DINT0.,R,,__GET_VAR(data__->RESET,));
  __SET_VAR(data__->CTU_DINT0.,PV,,5);
  CTU_DINT_body__(&data__->CTU_DINT0);
  __SET_VAR(data__->,Q,,__GET_VAR(data__->CTU_DINT0.Q,));
  __SET_VAR(data__->,_TMP_DINT_TO_INT18_OUT,,DINT_TO_INT(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (DINT)__GET_VAR(data__->CTU_DINT0.CV,)));
  __SET_VAR(data__->,DIGDISPY,,__GET_VAR(data__->_TMP_DINT_TO_INT18_OUT,));
